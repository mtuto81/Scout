## Done (0.0.7)
- UI Changes
- Remove logs from released apps
- Add failed-tool recovery: if a command fails, ask the model to correct it instead of finalizing too early
- Put API key in hash for display
...
## 0.1.0
- Add dedicated Linux tools instead of relying only on shell:
